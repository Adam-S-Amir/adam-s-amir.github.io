...
! function (e) {
    ...
    return (function () {
        ...
        3: [function (e, t, r) {
            ...
            }, r.shimAddTrackRemoveTrackWithNative = p, r.shimAddTrackRemoveTrack = function (e, t) {
                if (e.RTCPeerConnection) {
                    ...
                    var i = function (e) {
                            ...
                            return Object.keys(e).forEach(function (r) {
                                if ("require" !== r && "advanced" !== r && "mediaSource" !== r) {
                                    ...
                                    if (void 0 !== i.ideal) {
                                        ...
                                        var a = {};
                                        "number" == typeof i.ideal ? (a[o("min", r)] = i.ideal, t.optional.push(a), (a = {})[o("max", r)] = i.ideal, t.optional.push(a)) : (a[o("", r)] = i.ideal, t.optional.push(a))
                                    }
                        ...
                        o = function (e, o) {
                            ...
                            if (e && "object" === n(e.video)) {
                                ...
                                var p = t.version < 66;
                                if (c && ("user" === c.exact || "environment" === c.exact || "user" === c.ideal || "environment" === c.ideal) && !(r.mediaDevices.getSupportedConstraints && r.mediaDevices.getSupportedConstraints().facingMode && !p)) {
                                    delete e.video.facingMode;
                                    var d = void 0;
                                    if ("environment" === c.exact || "environment" === c.ideal ? d = ["back", "rear"] : ("user" === c.exact || "user" === c.ideal) && (d = ["front"]), d) return r.mediaDevices.enumerateDevices().then(function (t) {
        ...
        6: [function (e, t, r) {
            ...
            r.shimRTCIceCandidate = function (e) {
                if (e.RTCIceCandidate && (!e.RTCIceCandidate || !("foundation" in e.RTCIceCandidate.prototype))) {
                    ...
                    e.RTCIceCandidate = function (e) {
                        if ((void 0 === e ? "undefined" : i(e)) === "object" && e.candidate && 0 === e.candidate.indexOf("a=") && ((e = JSON.parse(JSON.stringify(e))).candidate = e.candidate.substr(2)), e.candidate && e.candidate.length) {
                            var r, n = Object.assign(new t(e), s.default.parseCandidate(e.candidate));
                    ...
                    e.RTCPeerConnection.prototype.setRemoteDescription = function () {
                        if (this._sctp = null, "chrome" === t.browser && t.version >= 76 && "plan-b" === this.getConfiguration().sdpSemantics && Object.defineProperty(this, "sctp", {
                            ...
                            var e = n(arguments[0]),
                                ...
                                c = o(arguments[0], e),
                                p = void 0;
                            p = 0 === s && 0 === c ? Number.POSITIVE_INFINITY : 0 === s || 0 === c ? Math.max(s, c) : Math.min(s, c);
                            var d = {};
                ...
                if (e.RTCPeerConnection && e.RTCPeerConnection.prototype) {
                    ...
                    r && 0 !== r.length && (e.RTCPeerConnection.prototype.setLocalDescription = function () {
                        var e = this,
                            t = arguments[0] || {};
                        if ((void 0 === t ? "undefined" : i(t)) !== "object" || t.type && t.sdp) return r.apply(this, arguments);
                        if (!(t = {
                                type: t.type,
                                sdp: t.sdp
            ...
            var o, a, s = (n = e("sdp"), n && n.__esModule ? n : {
                    default: n
                }),
                c = function (e) {
                    if (e && e.__esModule) return e;
        ...
        7: [function (e, t, r) {
            ...
            Object.defineProperty(r, "shimGetDisplayMedia", {
                ...
                if ((void 0 === e ? "undefined" : n(e)) === "object" && e.RTCPeerConnection && e.RTCRtpSender && (!e.RTCRtpSender || !("getStats" in e.RTCRtpSender.prototype))) {
                    var t = e.RTCPeerConnection.prototype.getSenders;
                    t && (e.RTCPeerConnection.prototype.getSenders = function () {
                        var e = this,
                            r = t.apply(this, []);
                ...
                if ((void 0 === e ? "undefined" : n(e)) === "object" && e.RTCPeerConnection && e.RTCRtpSender && (!e.RTCRtpSender || !("getStats" in e.RTCRtpReceiver.prototype))) {
        ...
        9: [function (e, t, r) {
            ...
            r.shimGetUserMedia = function (e, t) {
                ...
                if (r.getUserMedia = function (e, t, n) {
                        o.deprecated("navigator.getUserMedia", "navigator.mediaDevices.getUserMedia"), r.mediaDevices.getUserMedia(e).then(t, n)
                    ...
                    if (r.mediaDevices.getUserMedia = function (e) {
                            return (void 0 === e ? "undefined" : n(e)) === "object" && "object" === n(e.audio) && (a((e = JSON.parse(JSON.stringify(e))).audio, "autoGainControl", "mozAutoGainControl"), a(e.audio, "noiseSuppression", "mozNoiseSuppression")), s(e)
                    ...
                    if (i && i.prototype.applyConstraints) {
                        ...
                        i.prototype.applyConstraints = function (e) {
                            return "audio" === this.kind && (void 0 === e ? "undefined" : n(e)) === "object" && (a(e = JSON.parse(JSON.stringify(e)), "autoGainControl", "mozAutoGainControl"), a(e, "noiseSuppression", "mozNoiseSuppression")), p.apply(this, [e])
                        }
                    }
                }
            };
        ...
        10: [function (e, t, r) {
            ...
            r.shimLocalStreamsAPI = function (e) {
                    ...
                    e.RTCPeerConnection = function (e, r) {
                        if (e && e.iceServers) {
                            for (var n = [], i = 0; i < e.iceServers.length; i++) {
                                ...
                                !a.hasOwnProperty("urls") && a.hasOwnProperty("url") ? (o.deprecated("RTCIceServer.url", "RTCIceServer.urls"), (a = JSON.parse(JSON.stringify(a))).urls = a.url, delete a.url, n.push(a)) : n.push(e.iceServers[i])
                            }
                            e.iceServers = n
                        }
                        return new t(e, r)
                ...
                (void 0 === e ? "undefined" : n(e)) === "object" && !e.AudioContext && (e.AudioContext = e.webkitAudioContext)
            };
            var i, o = function (e) {
                if (e && e.__esModule) return e;
                var t = {};
        ...
        11: [function (e, t, r) {
            ...
            r.extractVersion = a, r.wrapPeerConnectionEvent = function (e, t, r) {
                if (e.RTCPeerConnection) {
                    ...
                    n.removeEventListener = function (e, r) {
                        if (e !== t || !this._eventMap || !this._eventMap[t] || !this._eventMap[t].has(r)) return o.apply(this, arguments);
                ...
                var r = e.navigator;
                return r.mozGetUserMedia ? (t.browser = "firefox", t.version = a(r.userAgent, /Firefox\/(\d+)\./, 1)) : r.webkitGetUserMedia || !1 === e.isSecureContext && e.webkitRTCPeerConnection && !e.RTCIceGatherer ? (t.browser = "chrome", t.version = a(r.userAgent, /Chrom(e|ium)\/(\d+)\./, 2)) : e.RTCPeerConnection && r.userAgent.match(/AppleWebKit\/(\d+)\./) ? (t.browser = "safari", t.version = a(r.userAgent, /AppleWebKit\/(\d+)\./, 1), t.supportsUnifiedPlan = e.RTCRtpTransceiver && "currentDirection" in e.RTCRtpTransceiver.prototype) : t.browser = "Not a supported browser.", t
            }, r.compactObject = function e(t) {
                return s(t) ? Object.keys(t).reduce(function (r, n) {
                    var i, o, a, c = s(t[n]),
                        p = c ? e(t[n]) : t[n],
                        d = c && !Object.keys(p).length;
                    return void 0 === p || d ? r : Object.assign(r, (i = {}, o = n, a = p, o in i ? Object.defineProperty(i, o, {
                        value: a,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
        ...
        12: [function (e, t, r) {
            ...
            i.generateIdentifier = function () {
                ...
                for (var t = {}, r = void 0, n = e.substr(e.indexOf(" ") + 1).split(";"), i = 0; i < n.length; i++) t[(r = n[i].trim().split("="))[0].trim()] = r[1];
                return t
                ...
                for (var t = {
                    ...
                    if (a) {
                        ...
                        switch (s.parameters = c.length ? i.parseFmtp(c[0]) : {}, s.rtcpFeedback = i.matchPrefix(e, "a=rtcp-fb:" + o + " ").map(i.parseRtcpFb), t.codecs.push(s), s.name.toUpperCase()) {
                            case "RED":
                            case "ULPFEC":
                ...
                p.length > 0 && p[0].length > 1 && p[0][0] === s && (c = p[0][1]), r.codecs.forEach(function (e) {
                    if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
                        ...
                        s && c && (r.rtx = {
                            ssrc: c
                        }), t.push(r), n && ((r = JSON.parse(JSON.stringify(r))).fec = {
                            ssrc: s,
                ...
                return d.length && (d = 0 === d[0].indexOf("b=TIAS:") ? parseInt(d[0].substr(7), 10) : 0 === d[0].indexOf("b=AS:") ? 950 * parseInt(d[0].substr(5), 10) - 16e3 : void 0, t.forEach(function (e) {
                    e.maxBitrate = d
                })), t
