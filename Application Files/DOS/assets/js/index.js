(function () {
  ...
  var D = function (a, b) {
      ...
      if (c.charAt(0) == "#") {
        ...
        for (var u = [], s = 0; s < b.length; s++)
          for (var C = b[s].getElementsByTagName(e),
  ...
  var H = function (a) {
      ...
      b.innerHTML = a;
      return {
        scripts: b.getElementsByTagName("script"),
        data: a
      }
    },
    I = function (a) {
      ...
      if (a.length <= 0) a = "";
        ...
        for (b = 1; b < a.length; b++) {
          ...
          c = e == 32 || e == 45 || e == 46;
          if (e == 99 || e == 67)
            if (a.charCodeAt(b - 1) == 77 || a.charCodeAt(b - 1) == 109) c = true
        }
        a = d
      }
      return a.replace(/ /g, "")
  ...
  f.each = function (a,
    ...
    if (e === undefined || f.isFunction(a))
      for (d in a) {
        ...
        for (d = a[0]; c < e && b.call(d, c, d) !== false; d = a[++c]);
    return a
  };
  f.noop = function () {};
  ...
  x.prototype = {
    ...
    init: function (a, b) {
      ...
      if (a.nodeType) {
        ...
        else if (typeof a === "string" && f.trim(a).indexOf("<") == 0 && f.trim(a).indexOf(">") != -1) {
    ...
    data: function (a, b) {
      if (typeof a ===
        "undefined" && this.length) return jQuery.data(this[0]);
          ...
          function injectSaveFiles() {
            if (options.saveFiles) {
              options.saveFiles.forEach(function (item) {
                _this.module.FS.writeFile(item.file, item.data, {
                  encoding: "binary"
                });
              })
            }
