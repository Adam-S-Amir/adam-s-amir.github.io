!function(e, t, r) {
    ...
    Object.assign(c.prototype, {
        ...
        reset: function() {
            ...
            this.dataTextures) {
                ...
                t.needsUpdate = !0;
                for (var r = t.image.data, i = 0; i < r.length; i++)
                    r[i] = 0
            }
        },
        flushData: function() {
        ...
        resetGridStencil: function() {
            ...
            var r = this.renderer;
            r.setClearColor(0, 1),
            r.clearTarget(this.textures.grid, !0, !1, !0);
            ...
            for (var o = 0; o < 2; o++)
                for (var s = 0; s < 2; s++) {
                    ...
                    r.render(this.scenes.stencil2, this.fullscreenCamera, this.textures.grid, !1))
                }
            i.depth.setLocked(!1),
            i.depth.setMask(!0),
            i.depth.setTest(!0),
        ...
        updateGrid: function() {
            ...
            t.render(this.scenes.mapParticlesToGrid, this.fullscreenCamera, this.textures.grid, !1),
        ...
        updateParticles: function() {
            ...
            t.render(this.scenes.fullscreen, this.fullscreenCamera, this.textures.particleWrite, !1),
        ...
        updateExplodeParticle: function() {
            ...
            t.render(this.scenes.mapParticlesToExplode, this.fullscreenCamera, this.textures.explode, !0),
        ...
        updateExplodedParticle: function() {
            ...
            this.fullscreenQuad.material = r,
            t.render(this.scenes.fullscreen, this.fullscreenCamera, this.textures.exploded, !1),
            this.fullscreenQuad.material = null,
        ...
        hasExploded: function() {
            ...
            return this.readByteData(e, this.textures.exploded.texture),
            e[0] > 0
        },
        ...
        readByteData: function(t, r) {
            ...
            this.renderer.render(this.scenes.fullscreen, this.fullscreenCamera, this.textures.fourUnsignedBytes, !0),
        ...
        tearSprings: function() {
            ...
            function o(e) {
                ...
                t.render(i.scenes.fullscreen, i.fullscreenCamera, i.textures[e + "Write"], !1),
        ...
        swapTextures: function(e, t) {
            ...
            if (!r[t])
                throw new Error("missing texture " + t);
            var i = r[e];
            r[e] = r[t],
            r[t] = i
        },
    ...
    var h, g, y, b, T, w, P, S, I, A, C, M, V, R, F, E, _, D, k, U, G, z, B, L, j, O, q, N, X, W = "\nvec2 indexToUV(float index, vec2 res){\n    vec2 uv = vec2(mod(index/res.x,1.0), floor( index/res.y ) / res.x);\n    return uv;\n}\nuniform sampler2D particleTex;\nuniform sampler2D paletteTex;\nuniform float size;\nuniform float playerParticleId;\nuniform vec2 cameraMin;\nuniform vec2 cameraMax;\nuniform float time;\n#ifndef USE_VERTEX_POSITION_FOR_PARTICLES\nattribute float particleIndex;\n#endif\nattribute float particleColor;\nvarying vec3 color;\nvoid main() {\n#ifdef USE_VERTEX_POSITION_FOR_PARTICLES\n    vec4 particlePosAndVel = vec4(position.xy, vec2(0.0));\n#else\n    vec2 particleUV = indexToUV(particleIndex,vec2(PARTICLE_RESOLUTION));\n    vec4 particlePosAndVel = texture2D(particleTex,particleUV);\n#endif\n    vec2 playerParticleUV = indexToUV(playerParticleId,vec2(PARTICLE_RESOLUTION)).xy;\n    vec4 playerParticlePosAndVel = texture2D(particleTex,playerParticleUV);\n    color = texture2D(paletteTex,vec2(mod(time,1.0), particleColor)).xyz;\n    vec2 cameraPos = clamp( playerParticlePosAndVel.xy, cameraMin, cameraMax );\n    vec4 mvPosition = modelViewMatrix * vec4( particlePosAndVel.xy - cameraPos, position.z, 1.0 );\n    gl_PointSize = size;\n    gl_Position = projectionMatrix * mvPosition;\n}\n", Q = "varying vec3 color;\nvoid main() {\n    gl_FragColor = vec4( color, 1.0 );\n}\n", H = {
        ...
        levels: {
            ...
            mario00: {
                backgroundColorPixel: [0, 0],
                music: "./assets/sound/world-1-1.mp3",
                cameraBox: {
                    min: {
                        x: 0,
                        y: 0
                ...
                portals: [{
                    type: "normal",
                    sound: "./assets/sound/smb_powerup.mp3",
                    color: [255, 0, 0, 255],
            ...
            "mario11-below": {
                backgroundColorPixel: [0, 0],
                music: "./assets/sound/02-underworld.mp3",
                cameraBox: {
                    min: {
                        x: 0,
                        y: 0
            ...
            mario14: {
                ...
                music: "./assets/sound/04-castle.mp3",
                cameraBox: {
                    min: {
                        x: 0,
                        y: 0
            ...
            "end-alpha": {
                backgroundColorPixel: [0, 0],
                music: "./assets/sound/smb_stage_clear.mp3",
                cameraBox: {
                    min: {
                        x: 0,
                        y: 0
        ...
        sfx: ["./assets/sound/jump.mp3", "./assets/sound/smb_1-up.mp3", "./assets/sound/smb_bowserfalls.mp3", "./assets/sound/smb_bowserfire.mp3", "./assets/sound/smb_breakblock.mp3", "./assets/sound/smb_bump.mp3", "./assets/sound/smb_coin.mp3", "./assets/sound/smb_fireball.mp3", "./assets/sound/smb_fireworks.mp3", "./assets/sound/smb_flagpole.mp3", "./assets/sound/smb_gameover.mp3", "./assets/sound/smb_jump-small.mp3", "./assets/sound/smb_jump-super.mp3", "./assets/sound/smb_kick.mp3", "./assets/sound/smb_mariodie.mp3", "./assets/sound/smb_pause.mp3", "./assets/sound/smb_pipe.mp3", "./assets/sound/smb_powerup_appears.mp3", "./assets/sound/smb_powerup.mp3", "./assets/sound/smb_stage_clear.mp3", "./assets/sound/smb_stomp.mp3", "./assets/sound/smb_vine.mp3", "./assets/sound/smb_warning.mp3", "./assets/sound/smb_world_clear.mp3"],
        music: {
            "./assets/sound/world-1-1.mp3": {
                loopEnd: 125.7,
                loopStart: .9
            },
            "./assets/sound/02-underworld.mp3": {
                loopEnd: 50,
                loopStart: .1
            },
            "./assets/sound/04-castle.mp3": {
                loopEnd: 48.6,
                loopStart: .6
            }
        }
    }, Y = -1 !== location.search.indexOf("debug"), Z = document.getElementById("container"), J = [], K = [], $ = 0;
    function ee(e, t, r) {
        if (e && le) {
            r = r || 0;
            var i = .6 + t;
    ...
    he)
        ...
        if (!e)
            return !1;
        var r = (t = document.getElementById("canvas")).getContext("webgl") || t.getContext("experimental-webgl")
          , i = r.createTexture();
        if (null === r.getExtension("OES_texture_float"))
            return !1;
        ...
        Promise.all([function() {
            ...
            Object.keys(H.levels).forEach(t=>{
                e.push("./assets/img/" + t + ".png", "./assets/img/" + t + "-mass.png", "./assets/img/" + t + "-groups.png", "./assets/img/" + t + "-depth.png", "./assets/img/" + t + "-triggers.png")
            }
            );
            var t, r = e.map(e=>(t = e,
            function(e) {
            ...
            document.getElementById("toggleSoundCheckbox").onchange = function() {
            ...
            t = H.sfx.concat(t);
            var r, i = (t = Array.from(new Set(t))).map(e=>(e = e,
            fe[e] ? Promise.resolve(fe[e]) : (me(),
            fetch(e).then(e=>e.arrayBuffer()).then(e=>new Promise(function(t, r) {
            ...
            !function() {
                ...
                P.radius;
                var t = 256 * P.radius;
                (g = new e.OrthographicCamera(-1,1,1,-1,.1,50)).position.z = t / 2,
                h.add(g),
                function() {
                    ...
                    }), r = new Float32Array(P.maxParticles), i = 0; i < P.maxParticles; i++)
                        r[i] = i;
                    var n = new Float32Array(P.maxParticles)
                      , a = new Float32Array(3 * P.maxParticles)
                      , o = new e.BufferGeometry;
                    o.addAttribute("position", new e.BufferAttribute(a,3)).addAttribute("particleIndex", new e.BufferAttribute(r,1)).addAttribute("particleColor", new e.BufferAttribute(n,1)),
            ...
            function() {
                ...
                (T = new r.GUI).add(P, "stiffness", 0, 5e3, .1),
                T.add(P, "damping", 0, 100, .1),
                T.add(P, "drag", 0, 1, .01),
                T.add(P, "friction", 0, 10, .001),
                T.add(P, "fixedTimeStep", .001, .1, .001),
                T.add(S, "debugTimeScale", 0, 5, .01),
                T.add(S, "paused"),
                T.add(S, "gravity", -2, 2, .001).onChange(function(e) {
                    P.gravity.y = e
                }),
            ...
            throw be.innerText = "Something went wrong :(",
            e
        })
    } else {
    ...
    function Pe(t, r) {
        if (E = t,
        _ = ye["./assets/img/" + t + ".png"],
        D = ye["./assets/img/" + t + "-mass.png"],
        k = ye["./assets/img/" + t + "-groups.png"],
        U = ye["./assets/img/" + t + "-depth.png"],
        G = ye["./assets/img/" + t + "-triggers.png"],
        Y) {
            var i = [_, D, k, U, G];
        ...
        for (var m = [0, 0, 0, 0], x = 4 * (H.levels[t].backgroundColorPixel[0] + _.width * H.levels[t].backgroundColorPixel[1]), f = 0; f < 4; f++)
            m[f] = a[f + x];
        Y && console.log(m),
        M = [];
        ...
        for (f = 0; f < _.width; f++)
            for (var C = 0; C < _.height; C++) {
                ...
                if (V !== m[0] || B !== m[1] || W !== m[2]) {
                    var Z = u[_e];
                    (he = T.get(Z)) === ie && (S.set(Math.min(f, S.x), Math.min(C, S.y)),
            ...
            for (C = 0; C < _.height; C++) {
                ...
                if (V !== m[0] || B !== m[1] || W !== m[2]) {
                    ...
                    if (T.has(Z)) {
                        ...
                        void 0 !== be && (g.set(b(f, C), be),
                        M[be] = xe,
                        J[be] = ve)
                    } else
                        0 !== Q && K.push(pe[0], pe[1], ve, xe)
                }
            }
        g.forEach(function(e, t) {
            var r, i = parseInt(t.split("_")[0], 10), n = parseInt(t.split("_")[1], 10);
            i > 44 && i < 48 && n > 15 && n < 19 || (void 0 !== (r = g.get(b(i, n + 1))) && P.connectParticles(e, r, !1),
        ...
        oe = g.get(b(Ae, Ce)),
        se = g.get(b(Ae, Me)),
        oe && se || (console.error("Stretch particle not found!"),
        oe = se = -1),
        q = [],
        N = I.x - S.x + 1,
        X = I.y - S.y + 1;
        ...
        R = new e.DataTexture(new Uint8Array(4 * h.length * 8),8,h.length,e.RGBAFormat);
        ...
        R.needsUpdate = !0,
        r) && (we(_e = [0, 0], r, _.width, _.height),
        P.singleStep(),
        function(e, t) {
        ...
        !function(e) {
            if (!O && H.levels[e].music.length) {
                ...
                O.connect(ce),
                O.loop = !0,
                H.music[t] && (O.loopEnd = H.music[t].loopEnd,
    ...
    function Ie(e) {
        ...
        return r.mozImageSmoothingEnabled = !1,
    ...
    function Ce() {
        ...
        C.material.uniforms.playerParticleId.value = A.material.uniforms.playerParticleId.value = ae,
        C.material.uniforms.paletteTex.value = A.material.uniforms.paletteTex.value = R,
        Ve();
    ...
    function Ve() {
        ...
        i.set(255, 255),
        E) {
            r.copy(H.levels[E].cameraBox.min),
            i.copy(H.levels[E].cameraBox.max);
            var n = r.y;
            r.y = w - i.y,
            i.y = w - n
        }
        ...
        r.x > i.x && (r.x = i.x = .5 * (r.x + i.x)),
        r.y > i.y && (r.y = i.y = .5 * (r.y + i.y)),
    ...
    function Re(t) {
        ...
        function(e) {
            ...
            S && S.paused || (P.step(n),
            P.maxSubSteps = $ > 60 ? 7 : 1);
            Fe = e
        }(t),
        C.material.uniforms.particleTex.value = A.material.uniforms.particleTex.value = P.particleTexture,
        C.material.uniforms.time.value = A.material.uniforms.time.value = P.time,
        y.render(h, g),
        function() {
            var t = P.time;
            if (t - ge < .5)
            ...
            if (P.hasExploded())
                ...
                Ue(),
                Se(),
                void ze("./assets/sound/smb_fireworks.mp3", function() {
                    setTimeout(function() {
                        ze("./assets/sound/smb_mariodie.mp3", function() {
                            P.clearExploded(),
                            _e = !1,
                            Pe(E),
                            Ce()
            ...
            if (r)
                null === Ee ? Ee = t : t - Ee > r.timeSeconds && (Pe(r.destinationLevel),
                Ce());
            else {
                P.readParticleData(ae, F),
                ee(O, ke(), 1);
                ...
                if (a) {
                    var o = function() {
                        Pe(a.destinationLevel, a.destinationPosition),
                        Ce(),
                        De = !1
                    };
                    if ("pipe" === a.type)
                        De = !0,
                        ze("./assets/sound/smb_pipe.mp3", o);
                    else if ("explosionTrigger" === a.type) {
                        var s = L.get(n);
                        s && (P.explodeParticle(s),
                        P.singleStep(),
                        P.clearExploded(),
                        L.set(n, 0))
                    } else
    ...
    var Fe, Ee = null, _e = !1, De = !1;
    function ke() {
        return Math.sqrt(Math.pow(F[2], 2), Math.pow(F[3], 2))
    }
    function Ue() {
        if (_e)
            P.applyForce.set(0, 0),
            P.params4.set(0, 0, 0, 0);
        else {
            P.params4.x = -1.2 * (B[39] - B[37]),
            P.applyForceMask.set(0, 0, 1, 0),
            P.applyForce.set(.1 * (B[39] - B[37]), 0 * (B[38] - B[40])),
            P.time - j > 1 && B[38] && (P.params4.y = -.5 * Math.min(0, -(B[38] - B[40])),
            P.params4.z = ae,
            P.params4.w = se,
            j = P.time,
            ze("./assets/sound/jump.mp3"))
        }
    }
    var Ge = {};
    function ze(e, t) {
