var Mario = {
    SpriteCuts: {
        CreateBlackFont: function() { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(0)) },
        CreateRedFont: function() { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(8)) },
        CreateGreenFont: function() { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(16)) },
        CreateBlueFont: function() { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(24)) },
        CreateYellowFont: function() {
            return new Enjine.SpriteFont([],
                Enjine.Resources.Images.font, 8, 8, this.GetCharArray(32))
        },
        CreatePinkFont: function() { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(40)) },
        CreateCyanFont: function() { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(48)) },
        CreateWhiteFont: function() { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(56)) },
        GetCharArray: function(a) { for (var b = [], c = 0, c = 32; c < 127; c++) b[c] = { X: (c - 32) * 8, Y: a }; return b },
        GetBackgroundSheet: function() {
            for (var a = [], b = 0, c = 0, e = Enjine.Resources.Images.background.width / 32, d = Enjine.Resources.Images.background.height / 32, b = 0; b < e; b++) { a[b] = []; for (c = 0; c < d; c++) a[b][c] = { X: b * 32, Y: c * 32, Width: 32, Height: 32 } }
            return a
        },
    ...
    Level: function(a, b) {
        ...
        for (var c = 0, e = 0, c = 0; c < this.Width; c++) { this.Map[c] = [];
            this.Data[c] = [];
            this.SpriteTemplates[c] = []; for (e = 0; e < this.Height; e++) this.Map[c][e] = 0, this.Data[c][e] = 0, this.SpriteTemplates[c][e] = null }
    }
};
Mario.Level.prototype = {
    Update: function() { for (var a = 0, b = 0, a = 0; a < this.Width; a++)
            for (b = 0; b < this.Height; b++) this.Data[a][b] > 0 && this.Data[a][b]-- },
    GetBlockCapped: function(a, b) { a < 0 && (a = 0);
        b < 0 && (b = 0);
        a >= this.Width && (a = this.Width - 1);
        b >= this.Height && (b = this.Height - 1); return this.Map[a][b] },
    GetBlock: function(a, b) { a < 0 && (a = 0); if (b < 0) return 0;
        a >= this.Width && (a = this.Width - 1);
        b >= this.Height && (b = this.Height - 1); return this.Map[a][b] },
    ...
    SetBlockData: function(a, b, c) { a < 0 || b < 0 || a >= this.Width || b >= this.Height || (this.Data[a][b] = c) },
    IsBlocking: function(a, b, c, e) { a = this.GetBlock(a, b);
        b = (Mario.Tile.Behaviors[a & 255] & Mario.Tile.BlockAll) > 0;
        b |= e > 0 && (Mario.Tile.Behaviors[a & 255] & Mario.Tile.BlockUpper) > 0;
        b |= e < 0 && (Mario.Tile.Behaviors[a & 255] & Mario.Tile.BlockLower) > 0; return b },
    GetSpriteTemplate: function(a, b) { if (a < 0) return null; if (b < 0) return null; if (a >= this.Width) return null; if (b >= this.Height) return null; return this.SpriteTemplates[a][b] },
    SetSpriteTemplate: function(a,
        b, c) { a < 0 || b < 0 || a >= this.Width || b >= this.Height || (this.SpriteTemplates[a][b] = c) }
};
Mario.BackgroundGenerator = function(a, b, c, e) { this.Width = a;
    this.Height = b;
    this.Distant = c;
    this.Type = e };
Mario.BackgroundGenerator.prototype = {
    SetValues: function(a, b, c, e) { this.Width = a;
        this.Height = b;
        this.Distant = c;
        this.Type = e },
    CreateLevel: function() { var a = new Mario.Level(this.Width, this.Height); switch (this.Type) {
            case Mario.LevelType.Overground:
                this.GenerateOverground(a); break;
            case Mario.LevelType.Underground:
                this.GenerateUnderground(a); break;
            case Mario.LevelType.Castle:
                this.GenerateCastle(a) } return a },
    ...
    GenerateUnderground: function(a) {
        ...
        if (this.Distant)
            for (var f =
                    0, b = 0; b < this.Width; b++) { Math.random() < 0.75 && (f = 1 - f); for (c = 0; c < this.Height; c++) { e = f;
                    d = c - 2; if (d < 0 || d > 4) d = 2, e = 0;
                    a.SetBlock(b, c, 4 + e + (3 + d) * 8) } } else
                for (b = 0; b < this.Width; b++)
                    for (c = 0; c < this.Height; c++) { e = b % 2;
                        d = c - 1; if (d < 0 || d > 7) d = 7, e = 0;
                        e === 0 && d > 1 && d < 5 && (e = -1, d = 0);
...
Mario.BackgroundRenderer = function(a, b, c, e) { this.Level = a;
    this.Width = b;
    this.Distance = e;
...
Mario.BackgroundRenderer.prototype.Draw = function(a, b) { for (var c = b.X / this.Distance, e = 0, d = 0, f = null, f = null, g = (c + this.Width) / 32 | 0, e = c / 32 | 0; e <= g; e++)
...
Mario.ImprovedNoise = function(a) { this.P = [];
    this.Shuffle(a) };
Mario.ImprovedNoise.prototype = {
    Shuffle: function() { for (var a = [], b = 0, c = 0, e = 0, b = 0; b < 256; b++) a[b] = b; for (b = 0; b < 256; b++) c = (Math.random() * 255 | 0) + b, e = a[b], a[b] = a[c], a[c] = e, this.P[b + 256] = this.P[b] = a[b] },
    PerlinNoise: function(a, b) { for (var c = 0, e = 0, d = 0, c = 0; c < 8; c++) d = 64 / (1 << c), e += this.Noise(a / d, b / d, 128) / (1 << c); return e },
    ...
    Fade: function(a) { return a * a * a * (a * (a * 6 - 15) + 10) },
    Lerp: function(a, b, c) { return b + a * (c - b) },
...
Mario.NotchSprite = function(a) { this.YPicO = this.XPicO = this.YPic = this.XPic = this.Ya = this.Xa = this.Y = this.X = this.YOld = this.XOld = 0;
...
Mario.NotchSprite.prototype.Draw = function(a) { var b = 0,
        c = 0;
...
Mario.NotchSprite.prototype.Update = function(a) { this.XOld = this.X;
    this.YOld = this.Y;
    this.Move();
    this.Delta = a };
Mario.NotchSprite.prototype.UpdateNoMove = function() { this.XOld = this.X;
    this.YOld = this.Y;
    this.Delta = 0 };
Mario.NotchSprite.prototype.Move = function() { this.X += this.Xa;
    this.Y += this.Ya };
Mario.NotchSprite.prototype.GetX = function(a) { return (this.XOld + (this.X - this.XOld) * a | 0) - this.XPicO };
Mario.NotchSprite.prototype.GetY = function(a) { return (this.YOld + (this.Y - this.YOld) * a | 0) - this.YPicO };
...
Mario.NotchSprite.prototype.ShellCollideCheck = function() { return !1 };
Mario.NotchSprite.prototype.FireballCollideCheck = function() { return !1 };
...
Mario.Character.prototype.Initialize = function(a) { this.World = a;
    this.X = 32;
...
Mario.Character.prototype.SetLarge = function(a, b) { b && (a = !0);
    a || (b = !1);
    ...
    this.Blink(!0) };
Mario.Character.prototype.Blink = function(a) { this.Large = a ? this.NewLarge : this.LastLarge;
...
Mario.Character.prototype.Move = function() {
    if (this.WinTime > 0) this.WinTime++, this.Ya = this.Xa = 0;
    ...
    else if (this.PowerUpTime !== 0) { this.PowerUpTime > 0 ? (this.PowerUpTime--, this.Blink(((this.PowerUpTime / 3 | 0) & 1) === 0)) : (this.PowerUpTime++, this.Blink(((-this.PowerUpTime / 3 | 0) & 1) === 0)); if (this.PowerUpTime === 0) this.World.Paused = !1;
        this.CalcPic() } else {
        ...
        if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Left) && !this.Ducking) { if (this.Facing === 1) this.Sliding = !1;
            this.Xa -= a; if (this.JumpTime >= 0) this.Facing = -1 }
        if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Right) && !this.Ducking) { if (this.Facing === -1) this.Sliding = !1;
            this.Xa += a; if (this.JumpTime >= 0) this.Facing = 1 }
...
Mario.Character.prototype.SubMove = function(a, b) {
    for (var c = !1; a > 8;) { if (!this.SubMove(8, 0)) return !1;
        a -= 8 }
    for (; a < -8;) { if (!this.SubMove(-8, 0)) return !1;
        a += 8 }
    for (; b > 8;) { if (!this.SubMove(0, 8)) return !1;
        b -= 8 }
    for (; b < -8;) { if (!this.SubMove(0, -8)) return !1;
        b += 8 }
    ...
    if (c) { if (a < 0) this.X = ((this.X - this.Width) / 16 | 0) * 16 + this.Width, this.Xa = 0; if (a > 0) this.X = ((this.X + this.Width) / 16 + 1 | 0) * 16 - this.Width - 1, this.Xa = 0; if (b < 0) this.Y = ((this.Y - this.Height) / 16 | 0) * 16 + this.Height, this.Ya = this.JumpTime = 0; if (b > 0) this.Y = ((this.Y - 1) / 16 + 1 | 0) * 16 - 1, this.OnGround = !0; return !1 } else return this.X +=
        a, this.Y += b, !0
};
Mario.Character.prototype.IsBlocking = function(a, b, c, e) {
    ...
    if ((Mario.Tile.Behaviors[d & 255] & Mario.Tile.PickUpable) > 0) { this.GetCoin();
        Enjine.Resources.PlaySound("coin");
        this.World.Level.SetBlock(a, b, 0); for (d = 0; d < 2; d++)
            for (f = 0; f < 2; f++) this.World.AddSprite(new Mario.Sparkle(this.World, a * 16 + d * 8 + (Math.random() * 8 | 0), b * 16 + f * 8 + (Math.random() * 8 | 0), 0, 0, 0, 2, 5)) }(d = this.World.Level.IsBlocking(a, b, c,
...
Mario.Character.prototype.Win = function() { this.XDeathPos = this.X | 0;
    this.YDeathPos = this.Y | 0;
    this.World.Paused = !0;
    this.WinTime = 1;
    Enjine.Resources.PlaySound("exit") };
Mario.Character.prototype.Die = function() { this.XDeathPos = this.X | 0;
    this.YDeathPos = this.Y | 0;
    this.World.Paused = !0;
    this.DeathTime = 1;
...
Mario.Character.prototype.GetMushroom = function() { if (!(this.DeathTime > 0 && this.World.Paused)) this.Large ? (this.GetCoin(), Enjine.Resources.PlaySound("coin")) : (this.World.Paused = !0, this.PowerUpTime = 18, Enjine.Resources.PlaySound("powerup"), this.SetLarge(!0, !1)) };
Mario.Character.prototype.Kick = function(a) { if (!(this.DeathTime > 0 && this.World.Paused)) Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) ? (this.Carried = a, a.Carried = !0) : (Enjine.Resources.PlaySound("kick"), this.InvulnerableTime = 1) };
Mario.Character.prototype.Get1Up = function() { Enjine.Resources.PlaySound("1up");
    this.Lives++; if (this.Lives === 99) this.Lives = 99 };
Mario.Character.prototype.GetCoin = function() { this.Coins++; if (this.Coins === 100) this.Coins = 0, this.Get1Up() };
Mario.LevelRenderer = function(a, b, c) { this.Width = b;
    this.Height = c;
    this.Level = a;
...
Mario.LevelRenderer.prototype.Update = function(a) { this.AnimTime += a;
    this.Tick = this.AnimTime | 0;
    this.Bounce += a * 30;
    this.Delta = a };
Mario.LevelRenderer.prototype.Draw = function(a, b) { this.DrawStatic(a, b);
    this.DrawDynamic(a, b) };
Mario.LevelRenderer.prototype.DrawStatic = function(a, b) { for (var c = 0, e = 0, d = 0, d = null, f = (b.X + this.Width) / 16 | 0, c = b.X / 16 | 0; c < f + 1; c++)
...
Mario.LevelGenerator = function(a, b) { this.Width = a;
    this.Height = b;
    this.Odds = [];
...
Mario.LevelGenerator.prototype = {
    CreateLevel: function(a, b) {
        ...
        if (a === Mario.LevelType.Castle || a === Mario.LevelType.Underground)
            for (d = 0; d < i.Width; d++) { h-- <= 0 && d > 4 && (g = Math.random() * 4 | 0, h = (Math.random() * 4 | 0) + 4); for (f = 0; f < i.Height; f++)(d > 4 && f <= g || d < 1) && i.SetBlock(d, f, 145) }
        this.FixWalls(i);
        return i
    },
    BuildZone: function(a,
        b, c) { for (var e = Math.random() * this.TotalOdds | 0, d = 0, f = 0, f = 0; f < this.Odds.length; f++) this.Odds[f] <= e && (d = f); switch (d) {
            ...
            case Mario.Odds.Cannons:
                return this.BuildCannons(a, b, c) } return 0 },
    ...
    BuildHillStraight: function(a, b, c) {
        ...
        for (this.AddEnemyLine(a, b + 1, b + e - 1, d - 1); i;)
            ...
            (Math.random() * 4 | 0) === 0 && (this.Decorate(a, k - 1, k + j + 1, h), i = !1); for (f = k; f < k + j; f++)
    ...
    BuildStraight: function(a, b, c, e) { var d = (Math.random() * 10 | 0) + 2,
            f = this.Height - 1 - (Math.random() * 4 | 0),
            g = 0,
            h = 0;
        e && (d = 10 + (Math.random() * 5 | 0));
        d > c && (d = c); for (g = b; g < b + d; g++)
            for (h = 0; h < this.Height; h++) h >= f && a.SetBlock(g, h, 145);
        e || d > 5 && this.Decorate(a, b, b + d, f); return d },
...
Mario.SpriteTemplate = function(a, b) { this.Type = a;
    this.Winged = b;
    this.LastVisibleTick = -1;
    this.IsDead = !1;
    this.Sprite = null };
Mario.SpriteTemplate.prototype = { Spawn: function(a, b, c, e) { if (!this.IsDead) this.Sprite = this.Type === Mario.Enemy.Flower ? new Mario.FlowerEnemy(a, b * 16 + 15, c * 16 + 24) : new Mario.Enemy(a, b * 16 + 8, c * 16 + 15, e, this.Type, this.Winged), this.Sprite.SpriteTemplate = this, a.AddSprite(this.Sprite) } };
...
Mario.Enemy.prototype.Move = function() {
    var a = 0,
        a = 0;
    this.WingTime++;
    if (this.DeadTime > 0) { this.DeadTime--; if (this.DeadTime === 0) { this.DeadTime = 1; for (a = 0; a < 8; a++) this.World.AddSprite(new Mario.Sparkle(this.World, (this.X + Math.random() * 16 - 8 | 0) + 4, (this.Y - Math.random() * 8 | 0) + 4, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5));
            this.World.RemoveSprite(this) }
        this.FlyDeath && (this.X += this.Xa, this.Y += this.Ya, this.Ya *= 0.95, this.Ya += 1) } else {
        if (this.Xa > 2) this.Facing = 1;
        if (this.Xa < -2) this.Facing = -1;
        ...
        if (this.OnGround) { if (this.Winged) this.Ya = -10 } else this.Ya += this.Winged ? 0.6 : 2;
...
Mario.Enemy.prototype.IsBlocking = function(a, b, c, e) { a = a / 16 | 0;
    b = b / 16 | 0; if (a === this.X / 16 | 0 && b === this.Y / 16 | 0) return !1; return this.World.Level.IsBlocking(a, b, c, e) };
Mario.Enemy.prototype.ShellCollideCheck = function(a) { if (this.DeadTime !== 0) return !1; var b = a.X - this.X,
        c = a.Y - this.Y; if (b > -16 && b < 16 && c > -this.Height && c < a.Height) { Enjine.Resources.PlaySound("kick");
        this.Xa = a.Facing * 2;
        this.Ya = -5;
        this.FlyDeath = !0; if (this.SpriteTemplate !== null) this.SpriteTemplate.IsDead = !0;
        this.DeadTime = 100;
        this.Winged = !1; return this.YFlip = !0 } return !1 };
Mario.Enemy.prototype.FireballCollideCheck = function(a) { if (this.DeadTime !== 0) return !1; var b = a.X - this.X,
        c = a.Y - this.Y; if (b > -16 && b < 16 && c > -this.Height && c < a.Height) { if (this.NoFireballDeath) return !0;
        Enjine.Resources.PlaySound("kick");
        this.Xa = a.Facing * 2;
        this.Ya = -5;
        this.FlyDeath = !0; if (this.SpriteTemplate !== null) this.SpriteTemplate.IsDead = !0;
        this.DeadTime = 100;
        this.Winged = !1; return this.YFlip = !0 } };
Mario.Enemy.prototype.BumpCheck = function(a, b) { if (this.DeadTime === 0 && this.X + this.Width > a * 16 && this.X - this.Width < a * 16 + 16 && b === (this.Y - 1) / 16 | 0) { Enjine.Resources.PlaySound("kick");
...
Mario.Fireball = function(a, b, c, e) { this.AirInertia = this.GroundInertia = 0.89;
...
Mario.Fireball.prototype.Move = function() {
    var a = 0;
    if (this.DeadTime > 0) { for (a = 0; a < 8; a++) this.World.AddSprite(new Mario.Sparkle(this.World, (this.X + Math.random() * 8 - 4 | 0) + 4, (this.Y + Math.random() * 8 - 4 | 0) + 2, Math.random() * 2 - 1 * this.Facing, Math.random() * 2 - 1, 0, 1, 5));
        this.World.RemoveSprite(this) } else {
...
Mario.Fireball.prototype.SubMove = function(a, b) {
    ...
    if (c) { if (a < 0) this.X = ((this.X - this.Width) / 16 | 0) * 16 + this.Width, this.Xa = 0; if (a > 0) this.X = ((this.X + this.Width) / 16 + 1 | 0) * 16 - this.Width - 1, this.Xa = 0; if (b < 0) this.Y = ((this.Y - this.Height) / 16 | 0) * 16 + this.Height, this.Ya = 0; if (b > 0) this.Y = ((this.Y - 1) / 16 + 1 | 0) * 16 - 1, this.OnGround = !0; return !1 } else return this.X += a, this.Y += b, !0
};
Mario.Fireball.prototype.IsBlocking = function(a, b, c, e) { a = a / 16 | 0;
    b = b / 16 | 0; if (a === this.X / 16 | 0 && b === this.Y / 16 | 0) return !1; return this.World.Level.IsBlocking(a, b, c, e) };
Mario.Fireball.prototype.Die = function() { this.Dead = !0;
    this.Xa = -this.Facing * 2;
    this.Ya = -5;
    this.DeadTime = 100 };
Mario.Sparkle = function(a, b, c, e, d) { this.World = a;
    this.X = b;
    this.Y = c;
    this.Xa = e;
    this.Ya = d;
...
Mario.Sparkle.prototype.Move = function() { this.XPic = this.Life > 10 ? 7 : this.XPicStart + (10 - this.Life) * 0.4 | 0;
    this.Life-- < 0 && this.World.RemoveSprite(this);
    this.X += this.Xa;
    this.Y += this.Ya };
Mario.CoinAnim = function(a, b, c) { this.World = a;
    this.Life = 10;
...
Mario.CoinAnim.prototype.Move = function() { var a = 0,
        b = 0; if (this.Life-- < 0) { this.World.RemoveSprite(this); for (a = 0; a < 2; a++)
    ...
    this.Y += this.Ya;
    this.Ya += 1 };
Mario.Mushroom = function(a, b, c) { this.RunTime = 0;
    this.AirInertia = this.GroundInertia = 0.89;
    this.OnGround = !1;
    this.Width = 4;
    this.Height = 24;
...
Mario.Mushroom.prototype.CollideCheck = function() { var a = Mario.MarioCharacter.X - this.X,
        b = Mario.MarioCharacter.Y - this.Y;
    a > -16 && a < 16 && b > -this.Height && b < Mario.MarioCharacter.Height && (Mario.MarioCharacter.GetMushroom(), this.World.RemoveSprite(this)) };
Mario.Mushroom.prototype.Move = function() { if (this.Life < 9) this.Layer = 0, this.Y--, this.Life++;
    else { this.Layer = 1; if (this.Xa > 2) this.Facing = 1; if (this.Xa < -2) this.Facing = -1;
        this.Xa = this.Facing * 1.75;
        this.XFlip = this.Facing === -1;
        this.RunTime += Math.abs(this.Xa) + 5; if (!this.SubMove(this.Xa, 0)) this.Facing = -this.Facing;
        this.OnGround = !1;
        this.SubMove(0, this.Ya);
        this.Ya *= 0.85;
        this.Xa *= this.OnGround ? this.GroundInertia : this.AirInertia;
...
Mario.Mushroom.prototype.SubMove = function(a, b) {
    ...
    a < 0 && (this.IsBlocking(this.X + a - this.Width, this.Y + b - this.Height, a, b) && (c = !0), this.IsBlocking(this.X + a -
        this.Width, this.Y + b - (this.Height / 2 | 0), a, b) && (c = !0), this.IsBlocking(this.X + a - this.Width, this.Y + b, a, b) && (c = !0));
    if (c) { if (a < 0) this.X = ((this.X - this.Width) / 16 | 0) * 16 + this.Width, this.Xa = 0; if (a > 0) this.X = ((this.X + this.Width) / 16 + 1 | 0) * 16 - this.Width - 1, this.Xa = 0; if (b < 0) this.Y = ((this.Y - this.Height) / 16 | 0) * 16 + this.Height, this.Ya = this.JumpTime = 0; if (b > 0) this.Y = ((this.Y - 1) / 16 + 1 | 0) * 16 - 1, this.OnGround = !0; return !1 } else return this.X += a, this.Y += b, !0
};
Mario.Mushroom.prototype.IsBlocking = function(a, b, c, e) { a = a / 16 | 0;
    b = b / 16 | 0; if (a === this.X / 16 | 0 && b === this.Y / 16 | 0) return !1; return this.World.Level.IsBlocking(a, b, c, e) };
...
Mario.Particle = function(a, b, c, e, d) { this.World = a;
    this.X = b;
    this.Y = c;
    this.Xa = e;
    this.Ya = d;
...
Mario.Particle.prototype.Move = function() { this.Life - this.Delta < 0 && this.World.RemoveSprite(this);
    this.Life -= this.Delta;
    this.X += this.Xa;
    this.Y += this.Ya;
    this.Ya *= 0.95;
    this.Ya += 3 };
Mario.FireFlower = function(a, b, c) { this.Width = 4;
    this.Height = 24;
    this.World = a;
    this.X = b;
    this.Y = c;
...
Mario.FireFlower.prototype.CollideCheck = function() { var a = Mario.MarioCharacter.X - this.X,
        b = Mario.MarioCharacter.Y - this.Y;
    a > -16 && a < 16 && b > -this.Height && b < Mario.MarioCharacter.Height && (Mario.MarioCharacter.GetFlower(), this.World.RemoveSprite(this)) };
Mario.FireFlower.prototype.Move = function() { if (this.Life < 9) this.Layer = 0, this.Y--, this.Life++ };
Mario.BulletBill = function(a, b, c, e) { this.Image = Enjine.Resources.Images.enemies;
    this.World = a;
    this.X = b;
    this.Y = c;
    this.Facing = e;
...
Mario.BulletBill.prototype.CollideCheck = function() { if (!this.Dead) { var a = Mario.MarioCharacter.X - this.X,
            b = Mario.MarioCharacter.Y - this.Y; if (a > -16 && a < 16 && b > -this.Height && b < this.World.Mario.Height) Mario.MarioCharacter.Y > 0 && b <= 0 && (!Mario.MarioCharacter.OnGround || !Mario.MarioCharacter.WasOnGround) ? (Mario.MarioCharacter.Stomp(this), this.Dead = !0, this.Xa = 0, this.Ya = 1, this.DeadTime = 100) : Mario.MarioCharacter.GetHurt() } };
Mario.BulletBill.prototype.Move = function() { var a = 0; if (this.DeadTime > 0) { this.DeadTime--; if (this.DeadTime === 0) { this.DeadTime = 1; for (a = 0; a < 8; a++) this.World.AddSprite(new Mario.Sparkle((this.X + Math.random() * 16 - 8 | 0) + 4, (this.Y + Math.random() * 8 | 0) + 4, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5));
            this.World.RemoveSprite(this) }
        this.X += this.Xa;
        this.Y += this.Ya;
        this.Ya *= 0.95;
        this.Ya += 1 } else this.Xa = this.Facing * 4, this.XFlip = this.Facing === -1, this.Move(this.Xa, 0) };
Mario.BulletBill.prototype.SubMove = function(a) { this.X += a; return !0 };
Mario.BulletBill.prototype.FireballCollideCheck = function(a) { if (this.DeadTime !== 0) return !1; var b = a.X - this.X,
        c = a.Y - this.Y; if (b > -16 && b < 16 && c > -this.Height && c < a.Height) return !0; return !1 };
Mario.BulletBill.prototype.ShellCollideCheck = function(a) { if (this.DeadTime !== 0) return !1; var b = a.X - this.X,
        c = a.Y - this.Y; if (b > -16 && b < 16 && c > -this.Height && c < a.Height) return Enjine.Resources.PlaySound("kick"), this.Dead = !0, this.Xa = 0, this.Ya = 1, this.DeadTime = 100, !0; return !1 };
Mario.FlowerEnemy = function(a, b, c) { this.Image = Enjine.Resources.Images.enemies;
    this.World = a;
    this.X = b;
    this.Y = c;
    this.Facing = 1;
    ...
    this.YStart = c;
    this.Ya = -8;
    this.Y -= 1; for (a = a = this.Tick = this.JumpTime = this.Layer = 0; a < 4; a++) this.Move() };
Mario.FlowerEnemy.prototype = new Mario.Enemy;
Mario.FlowerEnemy.prototype.Move = function() {
    var a = 0,
        a = 0;
    if (this.DeadTime > 0) { this.DeadTime--; if (this.DeadTime === 0) { this.DeadTime = 1; for (a = 0; a < 8; a++) this.World.AddSprite(new Mario.Sparkle((this.X + Math.random() * 16 - 8 | 0) + 4, (this.Y + Math.random() * 8 | 0) + 4, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5));
            this.World.RemoveSprite(this) }
        this.X += this.Xa;
        this.Y += this.Ya;
        this.Ya *= 0.95;
        this.Ya += 1 } else this.Tick++, this.Y >= this.YStart ? (this.YStart = this.Y, a = Math.abs(Mario.MarioCharacter.X - this.X) | 0, this.JumpTime++, this.Ya =
...
Mario.Shell = function(a, b, c, e) { this.World = a;
    this.X = b;
    this.Y = c;
    this.YPic = e;
    this.Image = Enjine.Resources.Images.enemies;
...
Mario.Shell.prototype.FireballCollideCheck = function(a) { if (this.DeadTime !== 0) return !1; var b = a.X - this.X,
        c = a.Y - this.Y; if (b > -16 && b < 16 && c > -this.Height && c < a.Height) { if (this.Facing !== 0) return !0;
        Enjine.Resources.PlaySound("kick");
        this.Xa = a.Facing * 2;
        this.Ya = -5; if (this.SpriteTemplate !== null) this.SpriteTemplate.IsDead = !0;
        this.DeadTime = 100; return this.YFlip = !0 } return !1 };
...
Mario.Shell.prototype.Move = function() {
    ...
    else if (this.DeadTime > 0) { this.DeadTime--; if (this.DeadTime === 0) { this.DeadTime = 1; for (a = 0; a < 8; a++) this.World.AddSprite(new Mario.Sparkle((this.X + Math.random() * 16 - 8 | 0) + 4, (this.Y + Math.random() * 8 | 0) + 4, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5));
            this.World.RemoveSprite(this) }
        this.X += this.Xa;
        this.Y += this.Ya;
        this.Ya *= 0.95;
...
Mario.Shell.prototype.IsBlocking = function(a, b, c, e) { a = a / 16 | 0;
    b = b / 16 | 0; if (a === (this.X / 16 | 0) && b === (this.Y / 16 | 0)) return !1; var d = this.World.Level.IsBlocking(a, b, c, e);
    d && e === 0 && c !== 0 && this.World.Bump(a, b, !0); return d };
Mario.Shell.prototype.BumpCheck = function(a, b) { if (this.X + this.Width > a * 16 && this.X - this.Width < a * 16 + 16 && b === ((this.Y - 1) / 16 | 0)) this.Facing = -Mario.MarioCharacter.Facing, this.Ya = -10 };
Mario.Shell.prototype.Die = function() { this.Dead = !0;
    this.Carried = !1;
    this.Xa = -this.Facing * 2;
    this.Ya = -5;
    this.DeadTime = 100 };
Mario.Shell.prototype.ShellCollideCheck = function(a) { if (this.DeadTime !== 0) return !1; var b = a.X - this.X,
        c = a.Y - this.Y; if (b > -16 && b < 16 && c > -this.Height && c < a.Height) { Enjine.Resources.PlaySound("kick"); if (Mario.MarioCharacter.Carried === a || Mario.MarioCharacter.Carried === this) Mario.MarioCharacter.Carried = null;
        this.Die();
        a.Die(); return !0 } return !1 };
Mario.Shell.prototype.Release = function() { this.Carried = !1;
    this.Facing = Mario.MarioCharacter.Facing;
    this.X += this.Facing * 8 };
Mario.TitleState = function() { this.font = this.bounce = this.logoY = this.camera = this.drawManager = null };
...
Mario.TitleState.prototype.Exit = function() { this.drawManager.Clear();
    delete this.drawManager;
    delete this.camera;
    delete this.font };
Mario.TitleState.prototype.Update = function(a) { this.bounce += a * 2;
    this.logoY = 20 + Math.sin(this.bounce) * 10;
    this.camera.X += a * 25;
    this.drawManager.Update(a) };
Mario.TitleState.prototype.Draw = function(a) { this.drawManager.Draw(a, this.camera);
...
Mario.TitleState.prototype.CheckForChange = function(a) { Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) && a.ChangeState(Mario.GlobalMapState) };
Mario.LoadingState = function() { this.Images = [];
    this.ImagesLoaded = !1;
    this.ScreenColor = 0;
...
Mario.LoadingState.prototype.Enter = function() {
    ...
    (new Audio).canPlayType("audio/mp3") ? Enjine.Resources.AddSound("1up", "./assets/audio/1-up.mp3", 1).AddSound("breakblock", "./assets/audio/breakblock.mp3").AddSound("bump", "./assets/audio/bump.mp3", 4).AddSound("cannon", "./assets/audio/cannon.mp3").AddSound("coin", "./assets/audio/coin.mp3", 5).AddSound("death", "./assets/audio/death.mp3",
        1).AddSound("exit", "./assets/audio/exit.mp3", 1).AddSound("fireball", "./assets/audio/fireball.mp3", 1).AddSound("jump", "./assets/audio/jump.mp3").AddSound("kick", "./assets/audio/kick.mp3").AddSound("pipe", "./assets/audio/pipe.mp3", 1).AddSound("powerdown", "./assets/audio/powerdown.mp3", 1).AddSound("powerup", "./assets/audio/powerup.mp3", 1).AddSound("sprout", "./assets/audio/sprout.mp3", 1).AddSound("stagestart", "./assets/audio/stagestart.mp3", 1).AddSound("stomp", "./assets/audio/stomp.mp3", 2) : Enjine.Resources.AddSound("1up", "./assets/audio/1-up.wav", 1).AddSound("breakblock", "./assets/audio/breakblock.wav").AddSound("bump",
        "./assets/audio/bump.wav", 2).AddSound("cannon", "./assets/audio/cannon.wav").AddSound("coin", "./assets/audio/coin.wav", 5).AddSound("death", "./assets/audio/death.wav", 1).AddSound("exit", "./assets/audio/exit.wav", 1).AddSound("fireball", "./assets/audio/fireball.wav", 1).AddSound("jump", "./assets/audio/jump.wav", 1).AddSound("kick", "./assets/audio/kick.wav", 1).AddSound("message", "./assets/audio/message.wav", 1).AddSound("pipe", "./assets/audio/pipe.wav", 1).AddSound("powerdown", "./assets/audio/powerdown.wav", 1).AddSound("powerup", "./assets/audio/powerup.wav", 1).AddSound("sprout", "./assets/audio/sprout.wav", 1).AddSound("stagestart",
        "./assets/audio/stagestart.wav", 1).AddSound("stomp", "./assets/audio/stomp.wav", 1);
    Mario.Tile.LoadBehaviors()
};
Mario.LoadingState.prototype.Exit = function() { delete this.Images };
Mario.LoadingState.prototype.Update = function(a) { if (!this.ImagesLoaded) { this.ImagesLoaded = !0; for (var b = 0, b = 0; b < this.Images.length; b++)
            if (Enjine.Resources.Images[this.Images[b].name].complete !== !0) { this.ImagesLoaded = !1; break } }
    this.ScreenColor += this.ColorDirection * 255 * a; if (this.ScreenColor > 255) this.ScreenColor = 255, this.ColorDirection = -1;
    else if (this.ScreenColor < 0) this.ScreenColor = 0, this.ColorDirection = 1 };
Mario.LoadingState.prototype.Draw = function(a) { if (this.ImagesLoaded) a.fillStyle = "rgb(0, 0, 0)";
    else { var b = parseInt(this.ScreenColor, 10);
        a.fillStyle = "rgb(" + b + "," + b + "," + b + ")" }
    a.fillRect(0, 0, 640, 480) };
Mario.LoadingState.prototype.CheckForChange = function(a) { if (this.ImagesLoaded) Mario.GlobalMapState = new Mario.MapState, a.ChangeState(new Mario.TitleState) };
Mario.LoseState = function() { this.font = this.gameOver = this.camera = this.drawManager = null;
    this.wasKeyDown = !1 };
...
Mario.LoseState.prototype.Exit = function() { this.drawManager.Clear();
    delete this.drawManager;
    delete this.camera;
    delete this.gameOver;
    delete this.font };
Mario.LoseState.prototype.Update = function(a) { this.drawManager.Update(a); if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S)) this.wasKeyDown = !0 };
Mario.LoseState.prototype.Draw = function(a) { this.drawManager.Draw(a, this.camera) };
Mario.LoseState.prototype.CheckForChange = function(a) { this.wasKeyDown && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) && a.ChangeState(new Mario.TitleState) };
Mario.WinState = function() { this.waitTime = 2;
...
Mario.WinState.prototype.Exit = function() { this.drawManager.Clear();
    delete this.drawManager;
    delete this.camera };
Mario.WinState.prototype.Update = function(a) { this.drawManager.Update(a); if (this.waitTime > 0) this.waitTime -= a;
    else if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S)) this.wasKeyDown = !0 };
Mario.WinState.prototype.Draw = function(a) { this.drawManager.Draw(a, this.camera) };
Mario.WinState.prototype.CheckForChange = function(a) { this.waitTime <= 0 && this.wasKeyDown && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) && a.ChangeState(new Mario.TitleState) };
Mario.MapTile = { Grass: 0, Water: 1, Level: 2, Road: 3, Decoration: 4 };
Mario.MapState = function() { this.camera = new Enjine.Camera;
    this.Level = [];
    this.Data = [];
...
Mario.MapState.prototype.Exit = function() { delete this.WaterSprite;
    ...
    delete this.Font };
Mario.MapState.prototype.NextWorld = function() { var a = !1;
    this.WorldNumber++; if (this.WorldNumber !== 8) { for (this.YFarthestCap = this.XFarthestCap = this.Farthest = this.LevelId = this.MoveTime = 0; !a;) a = this.GenerateLevel();
        this.RenderStatic() } };
...
Mario.MapState.prototype.FindConnection = function(a, b) { for (var c = 0, e = 0, c = 0; c < a; c++)
        for (e = 0; e < b; e++)
            if (this.Level[c][e] === Mario.MapTile.Level && this.Data[c][e] === -1) return this.Connect(c, e, a, b), !0;
    return !1 };
Mario.MapState.prototype.Connect = function(a, b, c, e) { for (var d = 1E4, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, h = j = 0; h < c; h++)
    ...
    this.Data[a][b] = -2 };
Mario.MapState.prototype.DrawRoad = function(a, b, c, e) { var d = !1;
    Math.random() > 0.5 && (d = !0); if (d) { for (; a > c;) this.Data[a][b] = 0, this.Level[a--][b] = Mario.MapTile.Road; for (; a < c;) this.Data[a][b] = 0, this.Level[a++][b] = Mario.MapTile.Road } for (; b > e;) this.Data[a][b] = 0, this.Level[a][b--] = Mario.MapTile.Road; for (; b < e;) this.Data[a][b] = 0, this.Level[a][b++] = Mario.MapTile.Road; if (!d) { for (; a > c;) this.Data[a][b] = 0, this.Level[a--][b] = Mario.MapTile.Road; for (; a < c;) this.Data[a][b] = 0, this.Level[a++][b] = Mario.MapTile.Road } };
Mario.MapState.prototype.FindCaps = function(a, b) { for (var c = 0, e = 0, d = -1, f = -1, g = 0, h = 0, i = 0, c = 0; c < a; c++)
        for (e = 0; e < b; e++)
            if (this.Level[c][e] === Mario.MapTile.Level) { g = 0; for (h = c - 1; h <= c + 1; h++)
...
Mario.MapState.prototype.IsRoad = function(a, b) { a < 0 && (a = 0);
    b < 0 && (b = 0); if (this.Level[a][b] === Mario.MapTile.Road) return !0; if (this.Level[a][b] === Mario.MapTile.Level) return !0; return !1 };
Mario.MapState.prototype.IsWater = function(a, b) { var c = 0,
        e = 0;
    a < 0 && (a = 0);
    b < 0 && (b = 0); for (c = 0; c < 2; c++)
        for (e = 0; e < 2; e++)
    ...
    if (this.WorldNumber !== 8) {
        ...
        if (this.MoveTime > 0) this.MoveTime--;
            ...
            if (this.CanEnterLevel && Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) && this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] !== -11 && this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] !== 0 && this.Data[b][c] >
                -10) { e = this.WorldNumber + 1;
                Mario.MarioCharacter.LevelString = e + "-";
                d = Mario.LevelType.Overground; if (this.Data[b][c] > 1 && (Math.random() * 3 | 0) === 0) d = Mario.LevelType.Underground;
...
Mario.MapState.prototype.TryWalking = function(a, b) { var c = this.XMario / 16 | 0,
        e = this.YMario / 16 | 0,
        d = c + a,
        f = e + b; if ((this.Level[d][f] === Mario.MapTile.Road || this.Level[d][f] === Mario.MapTile.Level) && !(this.Level[d][f] === Mario.MapTile.Road && this.Data[d][f] !== 0 && this.Data[c][e] !== 0 && this.Data[c][e] > -10)) this.XMarioA = a * 8, this.YMarioA = b * 8, this.MoveTime = this.CalcDistance(c, e, a, b) * 2 + 1 };
Mario.MapState.prototype.CalcDistance = function(a, b, c, e) { for (var d = 0;;) { a += c;
        b += e; if (this.Level[a][b] !== Mario.MapTile.Road) return d; if (this.Level[a - e][b + c] === Mario.MapTile.Road) return d; if (this.Level[a + e][b - c] === Mario.MapTile.Road) return d;
        d++ } };
Mario.MapState.prototype.Draw = function(a) {
    ...
    if (this.WorldNumber !== 8) {
        ...
        for (c = 0; c <= 15; c++)
            for (b = 20; b >= 0; b--)
                if (this.Level[b][c] === Mario.MapTile.Water) { if (this.IsWater(b * 2 - 1, c * 2 - 1)) this.WaterSprite.X = b * 16 - 8, this.WaterSprite.Y = c * 16 - 8, this.WaterSprite.Draw(a, this.camera) } else if (this.Level[b][c] === Mario.MapTile.Decoration) this.DecoSprite.X = b * 16, this.DecoSprite.Y = c * 16, this.DecoSprite.Draw(a, this.camera);
...
Mario.MapState.prototype.LevelWon = function() { var a = this.XMario / 16,
        b = this.YMario / 16;
    this.Data[a][b] === -2 ? this.NextWorld() : (this.Data[a][b] = this.Data[a][b] !== -3 ? 0 : -10, this.RenderStatic()) };
Mario.MapState.prototype.GetX = function() { return 160 };
Mario.MapState.prototype.GetY = function() { return 120 };
Mario.MapState.prototype.CheckForChange = function(a) { this.WorldNumber === 8 && a.ChangeState(new Mario.WinState);
    this.EnterLevel && a.ChangeState(new Mario.LevelState(this.LevelDifficulty, this.LevelType)) };
Mario.LevelState = function(a, b) { this.LevelDifficulty = a;
    this.LevelType = b;
...
Mario.LevelState.prototype.Exit = function() { delete this.Level;
    delete this.Layer;
    delete this.BgLayer;
    delete this.Sprites;
    delete this.Camera;
    ...
    delete this.FontShadow;
    delete this.Font };
Mario.LevelState.prototype.CheckShellCollide = function(a) { this.ShellsToCheck.push(a) };
Mario.LevelState.prototype.CheckFireballCollide = function(a) { this.FireballsToCheck.push(a) };
...
Mario.LevelState.prototype.Draw = function(a) {
    ...
    if (Mario.MarioCharacter.DeathTime > 0) { b = Mario.MarioCharacter.DeathTime + this.Delta;
        b = b * b * 0.1; if (b > 900 && (Mario.MarioCharacter.Lives--, this.GotoMapState = !0, Mario.MarioCharacter.Lives <= 0)) this.GotoLoseState = !0;
...
Mario.LevelState.prototype.DrawStringShadow = function(a, b, c, e) { this.Font.Strings[0] = { String: b, X: c * 8 + 4, Y: e * 8 + 4 };
...
Mario.LevelState.prototype.AddSprite = function(a) { this.Sprites.Add(a) };
Mario.LevelState.prototype.RemoveSprite = function(a) { this.Sprites.Remove(a) };
Mario.LevelState.prototype.Bump = function(a, b, c) {
    ...
    if ((Mario.Tile.Behaviors[e & 255] & Mario.Tile.Breakable) > 0 && (this.BumpInto(a, b - 1), c)) { Enjine.Resources.PlaySound("breakblock");
        this.Level.SetBlock(a, b, 0); for (d = 0; d < 2; d++)
            for (f = 0; f < 2; f++) this.AddSprite(new Mario.Particle(this, a * 16 + d * 8 + 4, b * 16 + f * 8 + 4, (d * 2 - 1) * 4, (f * 2 - 1) * 4 - 8)) }
};
Mario.LevelState.prototype.BumpInto = function(a, b) { var c = this.Level.GetBlock(a, b),
        e = 0;
    (Mario.Tile.Behaviors[c & 255] & Mario.Tile.PickUpable) > 0 && (Mario.MarioCharacter.GetCoin(), Enjine.Resources.PlaySound("coin"), this.Level.SetBlock(a, b, 0), this.AddSprite(new Mario.CoinAnim(a, b + 1))); for (e = 0; e < this.Sprites.Objects.length; e++) this.Sprites.Objects[e].BumpCheck(a, b) };
Mario.LevelState.prototype.CheckForChange = function(a) { this.GotoLoseState ? a.ChangeState(new Mario.LoseState) : this.GotoMapState && a.ChangeState(Mario.GlobalMapState) };