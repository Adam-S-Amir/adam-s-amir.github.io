...
Game.Launch = function() {
    ...
    Game.ErrorFrame = function() {
        l('javascriptError').innerHTML =
            ...
            'You can <a href="https://google.com" target="_blank">play Cookie Clicker over here</a>!<br>' +
    ...
    Game.Init = function() {
            ...
            Game.updateLog =
                ...
                '<div class="subsection update"></div>' +
                '<div class="title">10/18/2022 - I have absolutely no clue</div>' +
                '<script src="sandy.js"></script>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy()"  title="1,000">&bull;Made the game fun</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy1()" title="10,000">&bull;Added script injector</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy2()" title="100,000">&bull;Created Sandy</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy3()" title="1,000,000">&bull;Multiplied Golden Cookie appear time by two</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy4()" title="10,000,000">&bull;Polished CSS Filter</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy5()" title="100,000,000">&bull;Updated Icon Crates</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy6()" title="Auto-Clicker">&bull;Made CpS more accurate</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy7()" title="CpS">&bull;Made Mouse CpS more accurate</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy8()" title="Debug">&bull;Updated Debugger</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy9()" title="Upgrades">&bull;Nerfed some upgrades</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy10()" title="Ruin">&bull;Added Ancient Ruins</label></div>' +
                '<div class="listing">&nbsp;&nbsp;&nbsp;<label class="listing" onclick="Sandy11()" title="Auto-Buy">&bull;Buff Building costs</label></div>' +
                '</div>';
            ...
            */
                ...
                if (type == 2 || type == 3) {
                    ...
                    if (Game.useLocalStorage) {
                        ...
                        if (str.length < 10) {
                            ...
                            else Game.Notify('Saving failed!', 'Purchasing an upgrade and saving again might fix this.');
                        } else {
                            str = escape(str);
            ...
            Game.UpdateMenu = function() {
                ...
                if (Game.onMenu == 'prefs') {
                    str += '<div class="section">Options</div>' +
                        ...
                        '<div class="listing"><a class="option" onclick="popsoda">Toggle popups</a><label>Turn off the popups</label></div>' +
            ...
            new Game.Upgrade('Million fingers', 'Multiplies the gain from Thousand fingers by <b>5</b>.<q>clickityclickity</q>', 10000000, [0, 14]);
            Game.MakeTiered(Game.last, 5, 0);
            new Game.Upgrade('Billion fingers', 'Multiplies the gain from Thousand fingers by <b>10</b>.<q>clickityclickityclickity</q>', 100000000, [0, 15]);
            Game.MakeTiered(Game.last, 6, 0);
            new Game.Upgrade('Trillion fingers', 'Multiplies the gain from Thousand fingers by <b>20</b>.<q>clickityclickityclickityclickity</q>', 1000000000, [0, 16]);
            ...
            Game.NewUpgradeCookie({ name: 'White chocolate macadamia nut cookies', desc: 'Magnus\'s favorite.', icon: [8, 3], power: 2, price: 9999999999 });
            Game.NewUpgradeCookie({ name: 'All-chocolate cookies', desc: 'CHOCOVERDOSE.', icon: [9, 3], power: 2, price: 9999999999 * 5 });

            order = 100;
            new Game.Upgrade('Quadrillion fingers', 'Multiplies the gain from Thousand fingers by <b>20</b>.<q>clickityclickityclickityclickityclick</q>', 10000000000, [0, 17]);
            ...
            order = 100;
            new Game.Upgrade('Quintillion fingers', 'Multiplies the gain from Thousand fingers by <b>20</b>.<q>man, just go click click click click click, it\'s real easy, man.</q>', 10000000000000, [0, 18]);
            ...
            order = 100;
            new Game.Upgrade('Sextillion fingers', 'Multiplies the gain from Thousand fingers by <b>20</b>.<q>sometimes<br>things just<br>click</q>', 10000000000000000, [0, 19]);
            ...
            order = 100;
            new Game.Upgrade('Septillion fingers', 'Multiplies the gain from Thousand fingers by <b>20</b>.<q>[cursory flavor text]</q>', 10000000000000000000, [12, 20]);
            Game.MakeTiered(Game.last, 11, 0);
            new Game.Upgrade('Octillion fingers', 'Multiplies the gain from Thousand fingers by <b>20</b>.<q>Turns out you <b>can</b> quite put your finger on it.</q>', 10000000000000000000000, [12, 19]);
            ...
            Game.last.baseDesc = 'Cookie production multiplier <b>+1%</b> for every year Cookie Clicker has existed (currently : <b>+' + Beautify(years) + '%</b>).<q>Thank you for playing Cookie Clicker!<br>-Magnus</q>';
            ...
            new Game.TieredUpgrade('Nested', 'Fractal engines are <b>twice</b> as efficient.<q>Clever self-reference or shameful cross-promotion? This upgrade apparently has the gall to advertise a link to <u>google.com</u>, in a tooltip you can\'t even click.</q>', 'Fractal engine', 8);
            ...
            Game.NewUpgradeCookie({ name: 'Cheeseburger', desc: 'Absolutely no relation to cookies whatsoever - Magnus just wanted an excuse to draw a cheeseburger.', icon: [28, 30], require: 'Box of not cookies', power: 4, price: Math.pow(10, 40) });
            ...
            order = 10300;
            Game.NewUpgradeCookie({ name: 'Prism heart biscuits', desc: 'An every-flavor biscuit that stands for universal love and being true to yourself.', require: 'Eternal heart biscuits', season: 'valentines', icon: [30, 8], power: heartPower, price: 1000000000000000000000000 });
            Game.last.order = 10300.175;

            order = 19100;
            new Game.Upgrade('Kitten wages', 'Through clever accounting, this actually makes kitten upgrades <b>10% cheaper</b>.<q>Cats can have little a salary, as a treat.<br>Cats are expert hagglers and have a keen sense of bargaining, especially in the case of cash.</q>', 9000000000, [31, 8]);
            Game.last.pool = 'prestige';
            ...
            order = 100;
            new Game.Upgrade('Nonillion fingers', 'Multiplies the gain from Thousand fingers by <b>20</b>.<q>Only for the freakiest handshakes.</q>', 10000000000000000000000000, [12, 31]);
            ...
            order = 200;
            new Game.TieredUpgrade('Visits', 'Grandmas are <b>twice</b> as efficient.<q>In an extensive double-blind study (sample size: 12 millions), your researchers have found evidence that grandmas are up to twice as productive if you just come by and say hi once in a while. It\'s nice to check up on your grans! (Do not under any circumstances ingest any tea or tea-like substances the grandmas may offer you.)</q>', 'Grandma', 13);
            order = 300;
            new Game.TieredUpgrade('Reverse-veganism', 'Farms are <b>twice</b> as efficient.<q>Plants aren\'t for eating, plants are for exploitative agriculture and astronomical profit margins!</q>', 'Farm', 13);
            order = 400;
            new Game.TieredUpgrade('Caramel alloys', 'Mines are <b>twice</b> as efficient.<q>Your geologists have isolated a family of once-overlooked sugary ores that, when combined, may be turned into even more cookie ingredients. Your millions of miles of previously useless tunnels probably house insane amounts of the stuff!</q>', 'Mine', 13);
            order = 500;
            new Game.TieredUpgrade('The infinity engine', 'Factories are <b>twice</b> as efficient.<q>In this house, I guess we don\'t care much for the laws of thermodynamics.</q>', 'Factory', 13);
            order = 525;
            new Game.TieredUpgrade('Diminishing tax returns', 'Banks are <b>twice</b> as efficient.<q>Wow, they\'re tiny! Wish you\'d thought of that sooner!</q>', 'Bank', 13);
            order = 550;
            new Game.TieredUpgrade('Apparitions', 'Temples are <b>twice</b> as efficient.<q>You\'ve booked a deal with the higher-ups that schedules one weekly earthly apparition by a deity, angel, ascended prophet, or other holy figure. This should boost interest in cookie religion among youths as long as you can secure a decent time slot.</q>', 'Temple', 13);
            order = 575;
            new Game.TieredUpgrade('Wizard basements', 'Wizard towers are <b>twice</b> as efficient.<q>You\'ve received construction permits allowing you to build basements underneath each wizard tower. This provides a handy storage space for precious reagents, fizzled-out soul gems, and weird old magazines.</q>', 'Wizard tower', 13);
            order = 600;
            ...
            order = 700;
            new Game.TieredUpgrade('Chromatic cycling', 'Alchemy labs are <b>twice</b> as efficient.<q>All states of matter exist in a continuous loop. Having learned how to cycle through them, all you have to do is to freeze matter right on the state you need. For reference, the cookie state of matter is situated at precisely 163.719&deg;, right between lamellar gas and metaplasma.</q>', 'Alchemy lab', 13);
            order = 800;
            new Game.TieredUpgrade('Domestic rifts', 'Portals are <b>twice</b> as efficient.<q>You\'ve managed to manufacture portals that are convenient enough, and legally safe enough, that you can just stick them against walls inside buildings to connect rooms together in unusual configurations. In practice, this means your employees get to have much shorter bathroom breaks.</q>', 'Portal', 13);
            order = 900;
            new Game.TieredUpgrade('Patience abolished', 'Time machines are <b>twice</b> as efficient.<q>You wait for no one.</q>', 'Time machine', 13);
            order = 1000;
            new Game.TieredUpgrade('Delicious pull', 'Antimatter condensers are <b>twice</b> as efficient.<q>In addition to the 4 fundamental forces of the universe -gravity, electromagnetism, weak and strong interactions- your scientists have at long last confirmed the existence of a fifth one, mediated by sugar bosons; it dictates that any two masses of ingredient-like matter will, given enough time, eventually meet each other to produce a third, even tastier substance. Your team enthusiastically names it the delicious pull.</q>', 'Antimatter condenser', 13);
            order = 1100;
            new Game.TieredUpgrade('Occam\'s laser', 'Prisms are <b>twice</b> as efficient.<q>Invented by Franciscan friar William of Occam in 1<span></span>327. An impossibly clever use of light theory with a billion possible applications, some of which frightfully destructive. Confined to a single goat-skin parchment for hundreds of years until the patent expired and hit public domain, just now.</q>', 'Prism', 13);
            order = 1200;
            new Game.TieredUpgrade('On a streak', 'Chancemakers are <b>twice</b> as efficient.<q>Take a moment to appreciate how far you\'ve come. How lucky you\'ve been so far. It doesn\'t take a genius statistician to extrapolate a trend from this. There\'s no way anything bad could happen to you now. Right?</q>', 'Chancemaker', 13);
            order = 1300;
            new Game.TieredUpgrade('A box', 'Fractal engines are <b>twice</b> as efficient.<q>What\'s in that box? Why, it\'s a tiny replica of your office! And there\'s even a little you in there! And what\'s on the little desk... say - that\'s an even tinier box! And the little you is opening it, revealing an even tinier office! And in the tinier office there\'s- Hmm. You can think of a couple uses for this.</q>', 'Fractal engine', 13);
            order = 1400;
            new Game.TieredUpgrade('Hacker shades', 'Javascript consoles are <b>twice</b> as efficient.<q>I\'m in.</q>', 'Javascript console', 13);
            order = 1500;
            new Game.TieredUpgrade('Break the fifth wall', 'Idleverses are <b>twice</b> as efficient.<q>Huh, was that always there? Whatever it was, it\'s gone now. And what was behind is yours for the taking.</q>', 'Idleverse', 13);


            new Game.Upgrade('Cat ladies', 'Each kitten upgrade boosts grandma CpS by <b>29%</b>.<q>Oh no. Oh no no no. Ohhh this isn\'t right at all.</q>', 9000000000, [32, 3]);
            Game.last.pool = 'prestige';
            Game.last.parents = ['Kitten angels'];
            new Game.Upgrade('Milkhelp&reg; lactose intolerance relief tablets', 'Each rank of milk boosts grandma CpS by <b>5%</b>.<q>Aged like milk.</q>', 900000000000, [33, 3]);
            Game.last.pool = 'prestige';
            Game.last.parents = ['Cat ladies'];

            new Game.Upgrade('Aura gloves', 'Cursor levels boost clicks by <b>5%</b> each (up to cursor level 10).<q>Try not to high-five anyone wearing these. You don\'t want that mess on your hands.</q>', 555555555, [32, 4]);
            Game.last.pool = 'prestige';
            Game.last.parents = ['Halo gloves'];
            new Game.Upgrade('Luminous gloves', '<b>Aura gloves</b> are now effective up to cursor level 20.<q>These help power your clicks to absurd levels, but they\'re also quite handy when you want to light up the darkness on your way back from Glove World.</q>', 55555555555, [33, 4]);
            Game.last.pool = 'prestige';
            ...
            order = 30200;
            new Game.Achievement('God complex', 'Name yourself <b>Magnus</b>.<div class="warning">Note : usurpers incur a -1% CpS penalty until they rename themselves something else.</div><q>But that\'s not you, is it?</q>', [17, 5]);
            Game.last.pool = 'shadow';
            ...
            Game.BankAchievement('Feed me, Magnus');
            ...
            new Game.Achievement('Gaseous assets', 'Have your stock market profits surpass <b>a whole year</b> of CpS ($31,536,000).<q>Boy, how volatile!</q>', [18, 33]);
            Game.last.pool = 'shadow';
            ...
            order = 1050;
            new Game.Achievement('Gotta hand it to you', 'Have <b>700</b> cursors.', [0, 17]);
            order = 1100;
            ...
            order = 10000;
            new Game.Achievement('Seven horseshoes', 'Click <b>27777 golden cookies</b>.<q>Enough for one of those funky horses that graze near your factories.</q>', [21, 33]);
            Game.last.pool = 'shadow';
            ...
            order = 1050;
            new Game.Achievement('The devil\'s workshop', 'Have <b>800</b> cursors.', [0, 18]);
            order = 1200;
            Game.TieredAchievement('In the green', 'Have <b>600</b> farms.', 'Farm', 13);
            order = 1300;
            Game.TieredAchievement('Mountain out of a molehill, but like in a good way', 'Have <b>600</b> mines.', 'Mine', 13);
            order = 1400;
            Game.TieredAchievement('The wheels of progress', 'Have <b>600</b> factories.', 'Factory', 13);
            order = 1425;
            Game.TieredAchievement('That\'s rich', 'Have <b>600</b> banks.', 'Bank', 13);
            order = 1450;
            Game.TieredAchievement('Preaches and cream', 'Have <b>600</b> temples.', 'Temple', 13);
            order = 1475;
            Game.TieredAchievement('Magic thinking', 'Have <b>600</b> wizard towers.', 'Wizard tower', 13);
            order = 1500;
            Game.TieredAchievement('Is there life on Mars?', 'Have <b>600</b> shipments.<q>Yes, there is. You\'re currently using it as filling in experimental flavor prototype #810657.</q>', 'Shipment', 13);
            order = 1600;
            Game.TieredAchievement('Bad chemistry', 'Have <b>600</b> alchemy labs.', 'Alchemy lab', 13);
            order = 1700;
            Game.TieredAchievement('Reduced to gibbering heaps', 'Have <b>600</b> portals.', 'Portal', 13);
            order = 1800;
            Game.TieredAchievement('Back already?', 'Have <b>600</b> time machines.', 'Time machine', 13);
            order = 1900;
            Game.TieredAchievement('Nuclear throne', 'Have <b>600</b> antimatter condensers.', 'Antimatter condenser', 13);
            order = 2000;
            Game.TieredAchievement('Making light of the situation', 'Have <b>600</b> prisms.', 'Prism', 13);
            order = 2100;
            Game.TieredAchievement('Flip a cookie. Chips, I win. Crust, you lose.', 'Have <b>600</b> chancemakers.', 'Chancemaker', 13);
            order = 2200;
            Game.TieredAchievement('In and of itself', 'Have <b>600</b> fractal engines.', 'Fractal engine', 13);
            order = 2300;
            Game.TieredAchievement('Duck typing', 'Have <b>600</b> javascript consoles.<q>Hello, this is a duck typing. Got any grapes?</q>', 'Javascript console', 13);
            ...
            new Game.Achievement('Strange topologies', 'Reach level <b>10</b> idleverses.', [33, 26]);
...
window.onload = function() {
    ...
    if (!Game.ready) {
        console.log('[=== ' + choose([
            ...
            'Hey, Magnus here. Cheated cookies taste awful... or do they?',
        ]) + ' ===]');
        Game.Load();
        //try {Game.Load();}
        //catch(err) {console.log('ERROR : '+err.message);}
