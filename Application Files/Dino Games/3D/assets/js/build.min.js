...
class InputManager {
    constructor() {
        ...
        this.addKeyCallback = ((e, t, s, i = !1) => (this.callbacks_i++, this.callbacks[e][this.callbacks_i] = {
            ...
            e.pageY < document.documentElement.clientHeight / 2 ? t("space", !0) : t("down", !0)
        }), window.addEventListener("mouseup", e => {
            t("space", !1), t("down", !1)
        }), window.addEventListener("touchstart", e => {
            e.touches[0].pageY < document.documentElement.clientHeight / 2 ? t("space", !0) : t("down", !0)
...
class AudioManager {
    constructor() {
        this.base_path = config.base_path + "audio/", this.sounds = {
            score: new Howl({
            ...
            killed: new Howl({
                src: [this.base_path + "Randomize62.ogg"],
                preload: !0,
                autoplay: !1,
                loop: !1,
                volume: .15
            ...
            bg: new Howl({
                src: [this.base_path + "Reloaded Games - Music.ogg"],
                preload: !0,
                autoplay: !1,
                loop: !0,
                volume: .75
...
function nebulaCreateDynoDustEmitter(e = 5) {
    ...
    var n, r, h;
    return o.max = 10, t.addBehaviour(new Nebula.CrossZone(o, "bound")), n = 0, r = -1.1, h = 15.5, t.position.x = n, t.position.y = r, t.position.z = h, o.x = n, o.y = r, o.z = h, t.emit(), t
}
...
class NatureManager {
    ...
    initGroundDecoration(e, t, s, i = !0, a = "all", o = 11) {
        let n = load_manager.get_vox("ground_bg");
        ...
        for (let n = 0; n < o; n++) {
            ...
            if (o.scale.set(3, 2, 3), o.position.x = t, o.position.y = s, o.receiveShadow = i, n > 0) {
                let e = r[r.length - 1];
            ...
            }, r.push(o), scene.add(o)
        }
        r.leader = r.length - 1, this.ground_chunks_decoration.push(r)
    }
        ...
        for (let t in this.config.levels) {
            ...
            if (s.spawn) {
                for (let a = 0; a < s.max_amount; a++) {
                    ...
                    let n = o.misc_type.split("/")[0];
                    if (o.castShadow = !0, o.receiveShadow = !0, o.randLevel = i, "x_random_range" in s ? Array.isArray(s.x_random_range) ? o.position.x = this.random(i.x + s.x_random_range[1], i.x + s.x_random_range[0]) : o.position.x = this.random(i.x + s.x_random_range[n][1], i.x + s.x_random_range[n][0]) : o.position.x = this.random(i.x + this.config.misc_items[n].x_random_range[1], i.x + this.config.misc_items[n].x_random_range[0]), o.init_x = o.position.x, "behavior" in this.config.misc_items[n]) {
                        if ("roll" == this.config.misc_items[n].behavior) o.geometry.center(), o.position.y = i.box.max.y + .6, o.position.z = i.box.max.y, o.rotation.y = this.config.misc_items[n].y_rotate, o.rotate_vel = this.random(this.config.misc_items[n].random_rotate_vel[0], this.config.misc_items[n].random_rotate_vel[1]);
                        else if ("move" == this.config.misc_items[n].behavior) {
                            if (o.position.y = i.box.max.y, void 0 !== this.config.misc_items[n].z_random_rotate) {
                                let e = this.random(this.config.misc_items[n].z_random_rotate[0], this.config.misc_items[n].z_random_rotate[1]);
                                o.rotateZ(THREE.Math.degToRad(e))
                            }
                            if (void 0 !== this.config.misc_items[n].y_random_rotate) {
                                let e = this.random(this.config.misc_items[n].y_random_rotate[0], this.config.misc_items[n].y_random_rotate[1]);
                        ...
                        void 0 !== this.config.misc_items[n].y_add && (o.position.y += this.config.misc_items[n].y_add)
                    }
                    let r = this.random(this.config.misc_items[n].rescale_rand[0], this.config.misc_items[n].rescale_rand[1]);
                    o.scale.set(r, r, r);
...
class LoadManager {
    constructor() {
        this.assets = {}, this.vox = {}, this.onload = function () {}, this.onassetload = function () {}
    }
    set_status(e, t = !0) {
...
load_manager.set_loader("ground", [], function () {
    ...
    for (let a = 0; a < s.length; a++) e.parse(config.base_path + "objects/t-rex/other/" + s[a] + ".vox").then(function (e) {
        ...
        n.map = vox.MeshBuilder.textureFactory.getTexture(e), o.material = n;
        let r = o.createMesh();
        r.castShadow = !0, t[s[a]] = r, ++i == s.length && (load_manager.set_mesh("dyno_death", t), load_manager.set_status("dyno_death", !0), player.setPlayerDeathFrames(t))
    })
    ...
    e.load(config.base_path + "media/ground_top.png", function (e) {
...
class GameManager {
    ...
    async start() {
        ...
        if (!Math.round(adCount % 2)) {
            !document.getElementById("taboola-streamthumbnails").innerHTML || (document.getElementById("taboola-streamthumbnails").firstChild.firstChild.innerHTML = "");
