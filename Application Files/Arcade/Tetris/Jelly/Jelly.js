...
function GravityTetris() {
    ...
    this.initializePiece = function (p, x, y, type) {
        ...
        // wire up the springs
        //-------------------------------------------
        _pieces[p].springs[0].node1 = 0;
        _pieces[p].springs[0].node2 = 1;
        _pieces[p].springs[1].node1 = 0;
        _pieces[p].springs[1].node2 = 2;
        _pieces[p].springs[2].node1 = 0;
        _pieces[p].springs[2].node2 = 3;
        _pieces[p].springs[3].node1 = 1;
        _pieces[p].springs[3].node2 = 2;
        _pieces[p].springs[4].node1 = 1;
        _pieces[p].springs[4].node2 = 3;
        _pieces[p].springs[5].node1 = 2;
        _pieces[p].springs[5].node2 = 3;
